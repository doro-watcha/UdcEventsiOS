...
final class TabBarVC: UITabBarController, UINavigationControllerDelegate, UITabBarControllerDelegate {
    ...
    */
    ...
    override func viewDidLoad() {
        ...
        let vc1 = UINavigationController(rootViewController: FeedFrameVC())
        let vc2 = UINavigationController(rootViewController: MusicVC())
        //        let vc3 = UINavigationController(rootViewController: ExploreVC())
        let vc4 = UINavigationController(rootViewController: NotificationVC())
