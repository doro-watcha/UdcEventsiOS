...
final class DanceClassView: UIView {
    ...
    private func setup() {
        ...
        addSubview(posterImgUrl)
        addSubview(titleLabel)
        addSubview(artistLabel)
 

        
        let views = ["posterImg": posterImgUrl, "titleLabel": titleLabel, "artistLabel": artistLabel]
        
        addConstraints("H:|-24-[posterImg(40)]-024-|", options: .alignAllCenterY, metrics: nil, views: views)
    ...
    var danceClass: DanceClass? {
        didSet {
            ...
            posterImgUrl.imageUrl = URL(string : danceClass.posterImgUrl)
